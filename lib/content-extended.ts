...
const additionalLocations: LocationItem[] = [
  {
    ...
    title: "Residential Architects in Four Oaks",
    shortTitle: "Four Oaks",
    seoTitle: "Architects Four Oaks | Residential Architecture & Planning",
    description: "Residential architects in Four Oaks for house extensions, remodelling, replacement homes, planning applications and Building Regulations. Director-led advice from Hepburn Architects.",
    intro: "Director-led residential architecture for extensions, remodelling, replacement dwellings, planning applications and technical design in Four Oaks, Sutton Coldfield.",
    localContext: "Four Oaks combines substantial detached and period homes with later suburban properties, mature gardens and tree-lined streets. Residential proposals need to respond to the individual house, established frontage, roof form, landscape character and neighbouring amenity.",
    nearbyAreas: ["Sutton Coldfield", "Little Aston", "Aldridge", "Birmingham"],
    serviceSlugs: ["house-extensions", "loft-conversions", "new-build-homes", "planning-applications", "building-regulations"],
    points: ["House extensions and remodelling", "Replacement and one-off homes", "Conservation-area planning", "Building Regulations and technical design"],
    authorityPage: true,
    planningIntro: "Four Oaks is within Sutton Coldfield and Birmingham, so Birmingham City Council is the local planning authority for ordinary residential applications. Part, but not all, of Four Oaks is a designated Conservation Area.",
    projectTerms: ["four oaks", "sutton coldfield", "mere green", "streetly", "north birmingham"],
    projectIntro: "Published residential projects from Four Oaks, Sutton Coldfield and the wider Birmingham area, shown with their recorded project locations.",
  },
  {
    slug: "little-aston-architects",
    title: "Residential Architects in Little Aston",
    shortTitle: "Little Aston",
    seoTitle: "Architects Little Aston | Extensions, New Homes & Planning",
    description: "Architect-led house extensions, remodelling, new homes, planning applications and Building Regulations in Little Aston and surrounding Staffordshire areas.",
    intro: "Residential architectural design, planning and technical support for extensions, substantial remodelling, replacement dwellings and one-off homes in Little Aston, Staffordshire.",
    localContext: "Little Aston has a spacious residential character shaped by substantial detached houses, larger plots, mature boundaries and landscaped settings. Extensions and replacement homes need to balance the brief with plot coverage, access, trees, privacy and the relationship to neighbouring properties.",
    nearbyAreas: ["Four Oaks", "Sutton Coldfield", "Aldridge", "Walsall", "Birmingham"],
    serviceSlugs: ["house-extensions", "loft-conversions", "new-build-homes", "planning-applications", "building-regulations"],
    points: ["Extensions to substantial detached homes", "New and replacement dwellings", "Neighbourhood-plan assessment", "Building Regulations and technical design"],
    authorityPage: true,
    planningIntro: "Little Aston is in Staffordshire, outside Birmingham. Lichfield District Council is the local planning authority for ordinary residential applications, and the made Little Aston Neighbourhood Plan forms part of the planning context.",
    projectTerms: ["little aston", "staffordshire", "sutton coldfield", "aldridge", "walsall", "west midlands"],
    projectIntro: "Published residential projects from Little Aston and nearby Staffordshire and West Midlands locations, shown with their recorded project locations.",
  },
  {
