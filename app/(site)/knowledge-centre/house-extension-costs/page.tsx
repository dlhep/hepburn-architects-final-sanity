    ...
    <>
      ...
      <main>
        ...
        <section className={styles.processSection}>
          <div className={`shell ${styles.twoColumn}`}>
            <div className={styles.stickyHeading}><small className="eyebrow">From brief to tender</small><h2>How to Set a Realistic Extension Budget</h2><Link className={styles.textLink} href="/services/house-extensions">Explore our house extension service <ArrowRight size={16} /></Link></div>
