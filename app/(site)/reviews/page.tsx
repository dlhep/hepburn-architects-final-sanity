...
export const metadata: Metadata = createSeoMetadata({ title: "Hepburn Architects Reviews | Client Experiences", description: "Read verified client reviews of Hepburn Architects for residential, planning and development projects across Birmingham, Solihull and the West Midlands.", path: "/reviews" });
...
export default async function ReviewsPage() {
  ...
  return <>
    ...
    <section className="section reviews-hero"><div className="shell page-intro"><small className="eyebrow">Client experiences</small><h1>Reviews of Hepburn Architects</h1><p className="lead">Read verified client experiences from residential, planning and development projects across Birmingham, Solihull and the wider West Midlands.</p><div className="actions"><Link className="btn primary" href="/contact" data-track-event="review_cta_click">Discuss Your Project <ArrowRight size={17} /></Link><Link className="btn secondary" href="/projects" data-track-event="review_cta_click">View Projects <ArrowRight size={17} /></Link></div></div></section>
    ...
    <section className="section reviews-independent"><div className="shell"><div className="section-heading"><small className="eyebrow">Independent sources</small><h2>Read independent reviews</h2></div><p>Google Business Profile reviews retain the reviewer name, rating, date and original wording supplied by Google. Where profiles are configured, you can also read feedback on the original platform.</p><div className="actions">{site.googleBusinessBirmingham ? <a className="btn secondary" href={site.googleBusinessBirmingham} target="_blank" rel="noopener noreferrer" data-track-event="review_source_click">Google Business Profile Birmingham <ArrowRight size={17} /></a> : null}{site.facebook ? <a className="btn secondary" href={site.facebook} target="_blank" rel="noopener noreferrer" data-track-event="review_source_click">Facebook <ArrowRight size={17} /></a> : null}</div></div></section>
