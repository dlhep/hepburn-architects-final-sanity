...
export default async function ReviewsPage() {
  ...
  return <>
    ...
    <section className="section reviews-independent"><div className="shell"><div className="section-heading"><small className="eyebrow">Independent sources</small><h2>Read independent reviews</h2></div><p>Google Business Profile reviews retain the reviewer name, rating, date and original wording supplied by Google. Where profiles are configured, you can also read feedback on the original platform.</p><div className="actions">{site.googleBusinessBirmingham ? <a className="btn secondary" href={site.googleBusinessBirmingham} target="_blank" rel="noopener noreferrer" data-track-event="review_source_click">Google Business Profile Birmingham <ArrowRight size={17} /></a> : null}{site.googleBusinessNorthEast ? <a className="btn secondary" href={site.googleBusinessNorthEast} target="_blank" rel="noopener noreferrer" data-track-event="review_source_click">Google Business Profile North East <ArrowRight size={17} /></a> : null}{site.facebook ? <a className="btn secondary" href={site.facebook} target="_blank" rel="noopener noreferrer" data-track-event="review_source_click">Facebook <ArrowRight size={17} /></a> : null}</div></div></section>
