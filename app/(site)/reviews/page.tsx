...
export default async function ReviewsPage() {
  ...
  return <>
    ...
    <section className="section reviews-independent"><div className="shell"><div className="section-heading"><small className="eyebrow">Independent sources</small><h2>Read independent reviews</h2></div><p>Where profiles are configured, you can also read feedback on the original platform.</p><div className="actions"><a className="btn secondary" href={site.googleBusiness} target="_blank" rel="noopener noreferrer" data-track-event="review_source_click">Google Business Profile <ArrowRight size={17} /></a><a className="btn secondary" href={site.facebook} target="_blank" rel="noopener noreferrer" data-track-event="review_source_click">Facebook <ArrowRight size={17} /></a></div></div></section>
