    ...
    <>
      ...
      <header className={styles.hero}><div className="shell">
        ...
        <div className={styles.heroGrid}>
          <div className={styles.heroCopy}><small className="eyebrow">House Extension Timeline</small><h1>How Long Does a House Extension Take?</h1><p className={styles.standfirst}>Construction may represent only one part of the overall programme. Surveys, design decisions, planning, technical coordination and contractor selection all need to be considered before work starts on site.</p><p>The sequence varies with the property, local authority, design complexity, consultant input and procurement route. No responsible programme can guarantee approval or completion by a fixed date.</p><div className="actions"><a className="btn primary" href={site.calendly} target="_blank" rel="noopener noreferrer"><CalendarDays size={17} />Discuss Your Extension</a><Link className="btn secondary" href="/services/house-extensions">Explore House Extension Services</Link></div></div>
