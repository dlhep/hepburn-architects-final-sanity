...
export const metadata:Metadata={title:"Residential Planning & Architecture Guides | Hepburn Architects",description:"SEO-rich practical guides covering planning permission, extensions, loft conversions, HMOs, flat conversions, architect fees and Building Regulations.",alternates:{canonical:"/guides"}};
