...
export const projectType = defineType({
  ...
  fields: [
    ...
    defineField({ name: "websiteRegion", title: "Website region", type: "string", group: "content", options: { list: ["Midlands", "North East"] }, description: "North East projects are excluded from the .co.uk portfolio." }),
