  ...
  return (
    <>
      ...
      <main>
        ...
        <section className={styles.relatedSection}><div className={`shell ${styles.twoColumn}`}><div><small className="eyebrow">Continue planning</small><h2>From Design Idea to Project Brief</h2></div><div><Link href="/knowledge-centre/house-extensions">Complete Guide to House Extensions<ArrowRight size={16} /></Link><Link href="/services/house-extensions">House Extension Architectural Service<ArrowRight size={16} /></Link><Link href="/knowledge-centre/building-regulations">Building Regulations Explained<ArrowRight size={16} /></Link></div></div></section>
